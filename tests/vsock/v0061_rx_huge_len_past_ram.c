...
/*
 * V0061: vsock rx writable len past end of guest RAM.
 *
...
static test_result_t test_vsock_rx_huge_len_past_ram(struct virtio_dev *dev,
                                                     struct vring *vr)
{
...
REGISTER_TEST(V0061, VIRTIO_PCI_DEVICE_VSOCK, test_vsock_rx_huge_len_past_ram,
              "Vsock rx writable len crosses end of RAM",
