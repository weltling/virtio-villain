...
/*
 * L0201: virtio-balloon device survives a snapshot of the running VM.
 *
...
static test_result_t test_balloon_survives_snapshot(struct virtio_dev *dev,
                                                    struct vring *vr)
{
    (void)vr;
...
REGISTER_TEST(L0201, VIRTIO_PCI_DEVICE_BALLOON,
              test_balloon_survives_snapshot,
              "virtio-balloon survives a host triggered snapshot",
