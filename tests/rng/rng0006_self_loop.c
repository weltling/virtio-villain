...
/*
 * RNG0006: RNG chain with self-loop.
 *
...
static test_result_t test_rng_self_loop(struct virtio_dev *dev,
                                        struct vring *vr)
{
...
REGISTER_TEST(RNG0006, VIRTIO_PCI_DEVICE_RNG, test_rng_self_loop,
              "RNG chain self-loop",
