                                         ...
                                         struct vring *vr)
{
    ...
    tmf->subtype = VIRTIO_SCSI_T_TMF_LOGICAL_UNIT_RESET;
...
REGISTER_TEST_Q(SCSI0246, VIRTIO_PCI_DEVICE_SCSI, test_scsi_lun_reset,
                "LOGICAL UNIT RESET terminates a throttled read",
