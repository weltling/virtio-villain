...
/*
 * SCSI0143: four_batched_reads
 *
 * Post four READ(10) requests before kicking and confirm the device
 * completes all four.
 */
#include "tests/scsi/scsi_util.h"

static test_result_t test_scsi_four_reads(struct virtio_dev *dev,
                                          struct vring *vr)
{
...
REGISTER_TEST_Q(SCSI0143, VIRTIO_PCI_DEVICE_SCSI, test_scsi_four_reads,
                "Four batched READ requests all complete",
