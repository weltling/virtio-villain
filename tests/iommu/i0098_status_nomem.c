...
/*
 * I0098: MAP a 2 MB range with input_range too small.
 *
 * v1.4 5.13.6.3: a MAP exceeding the device input_range must
 * be rejected. Submit a 2 MB MAP at virt_start = 0 in a fresh
 * domain.
 */
...
static test_result_t test(struct virtio_dev *dev, struct vring *vr)
{
    ...
    a->domain = 0x9801; a->endpoint = 0; a->tail.status = 0xFF;
...
REGISTER_TEST(I0098, VIRTIO_PCI_DEVICE_IOMMU, test,
              "2 MB MAP into fresh domain",
