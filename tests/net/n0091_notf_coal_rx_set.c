...
/*
 * N0091: net_notf_coal_rx_set
 *
 * Send VIRTIO_NET_CTRL_NOTF_COAL_RX_SET with valid parameters.
 * Spec v1.3 5.1.6.5: configures coalescing parameters for all
 * receive virtqueues.
 */
                                           ...
                                           struct vring *vr)
{
    ...
    ctrl->command = VIRTIO_NET_CTRL_NOTF_COAL_RX_SET;
    coal->max_packets = 64;
    coal->max_usecs = 1000;
    *status = 0xFF;
...
REGISTER_TEST_Q_REQUIRES(N0091, VIRTIO_PCI_DEVICE_NET, test_net_notf_coal_rx,
              "NOTF_COAL RX_SET with valid parameters",
