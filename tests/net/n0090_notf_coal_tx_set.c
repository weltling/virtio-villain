...
/*
 * N0090: net_notf_coal_tx_set
 *
 * Send VIRTIO_NET_CTRL_NOTF_COAL_TX_SET with valid parameters on
 * the control virtqueue. Spec v1.3 5.1.6.5: configures coalescing
...
static test_result_t test_net_notf_coal_tx(struct virtio_dev *dev,
                                           struct vring *vr)
{
...
REGISTER_TEST_Q_REQUIRES(N0090, VIRTIO_PCI_DEVICE_NET, test_net_notf_coal_tx,
              "NOTF_COAL TX_SET with valid parameters",
