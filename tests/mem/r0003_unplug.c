...
/*
 * R0003: Virtio-mem unplug request.
 *
...
static test_result_t test_mem_unplug(struct virtio_dev *dev,
                                     struct vring *vr)
{
...
REGISTER_TEST(R0003, VIRTIO_PCI_DEVICE_MEM, test_mem_unplug,
              "Unplug a single memory block",
