...
static test_result_t test_mem_plug(struct virtio_dev *dev,
                                   struct vring *vr)
{
    ...
    /* Read region start from device config */
...
REGISTER_TEST(R0002, VIRTIO_PCI_DEVICE_MEM, test_mem_plug,
              "Plug a single memory block",
